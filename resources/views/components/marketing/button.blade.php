...
@php
    ...
    if ($variant === 'primary') {
        ...
        $classes .= ' rounded-full border border-transparent bg-gray-950 shadow-md';
        $classes .= ' text-base text-white';
        $classes .= ' hover:bg-gray-800';
        $classes .= ' disabled:bg-gray-950 disabled:opacity-40 disabled:cursor-default disabled:pointer-events-none';
        ...
        $classes .= ' text-base font-medium whitespace-nowrap text-gray-950';
