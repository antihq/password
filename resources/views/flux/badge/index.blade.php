...
$classes = Flux::classes()
    ...
    ->add(match ($size) {
        'lg' => 'text-base/5 sm:text-sm/6 **:data-flux-badge-icon:me-2',
        default => 'text-base/5 sm:text-sm/6 py-0.5 **:data-flux-badge-icon:me-1.5',
        'sm' => 'text-sm/5 sm:text-xs/5 py-0.5 **:data-flux-badge-icon:size-3 **:data-flux-badge-icon:me-1',
    })
    ->add(match ($variant) {
